...
function Header() {
  ...
  return (
    <div className=' bg-white flex-wrap w-screen h-[80px] flex items-center justify-evenly max-sm:justify-between  '>
        ...
        <div className='flex w-[10vw] h-[5vh] justify-between items-center  max-sm:mr-1 max-sm:w-[30vw]'>
            <h2 className='text-2xl cursor-pointer xl:text-xl md:text-xl md:m-3 sm:text-[15px] max-sm:text-xs  ' onClick={() => navigate("/")} >Home</h2>
            <h2 className='text-2xl cursor-pointer xl:text-xl md:text-xl  sm:text-[15px]   max-sm:text-xs m-3 ' onClick={() => navigate("/Cart")}>Cart({cartitem.length})</h2>
